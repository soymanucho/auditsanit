...
@section('title')
  Editando categoria de Modulo
@endsection

@section('breadcrumb-items')
  <li><a href="{!! route('home') !!}"><i class="fa "></i> Inicio</a></li>
  <li><a href="{!! route('show-modulecategories') !!}"><i class="fa "></i> Categoria de modulo</a></li>
  ...
  <div class="panel-body">
    ...
    <div class="box box-success">
      <div class="box-header with-border">
        <h3 class="box-title">Editando categoria de modulo</h3>
      </div>
