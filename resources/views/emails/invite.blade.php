								...
								<table cellpadding="0" cellspacing="0" border="0" align="center" width="600">
									...
									<tr>
										...
										<td width="400" align="center" style="padding-bottom:5px;">
											<div class="contentEditableContainer contentTextEditable">
												<div class="contentEditable" >
													<p >Si recibiste este correo, es porque alguien te está invitando a participar en la aplicación web de auditoría sanitaria.</p>
												</div>
											</div>
										</td>
										<td width="100">&nbsp;</td>
											...
											<table cellpadding="0" cellspacing="0" border="0" align="center" width="200" height="50">
												<tr>
													<td bgcolor="#ED006F" align="center" style="border-radius:4px;" width="200" height="50">
														<div class="contentEditableContainer contentTextEditable">
															<div class="contentEditable" >
																<a target='_blank' href="{{ route('accept', $invite->token) }}" class='link2'>Aceptar invitación</a>
															</div>
														</div>
