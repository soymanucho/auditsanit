...
@section('content')
  ...
  <a class="float-right btn btn-app" href="{!! route('audit-detail-expedient',compact('audit')) !!}">Ir a los diagnosticos e indicaciones</a>
  <i class="glyphicon glyphicon-menu-right"></i>
  <a class="float-right btn btn-app disabled" href="{!! route('audit-detail-result',compact('audit')) !!}">Ver resultados de la auditoría</a>
  <i class="glyphicon glyphicon-menu-right"></i>
