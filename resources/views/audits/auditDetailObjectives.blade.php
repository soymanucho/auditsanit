...
@section('content')
  ...
  <a class="float-right btn bg-navy disabled" href="{!! route('audit-detail-objectives',compact('audit')) !!}"><i class="glyphicon glyphicon-menu-right"></i>   Objetivos e instrucciones</a>
...
<div class="box box-widget">
  ...
  @include('audits.auditobjectives')
