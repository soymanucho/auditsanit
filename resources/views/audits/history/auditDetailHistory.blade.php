...
@section('content')
  <div class="row">
    <div class="btn-group" style="width:100%">
      ...
      <a class="col-lg-2 col-sm-12 col-md-6 btn bg-navy disabled" href="{!! route('audit-detail-history',compact('audit')) !!}"><i class="glyphicon glyphicon-menu-right"></i>    Historial de estados</a>
